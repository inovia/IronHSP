...
#include "Desktop/DxInputDesktop.h"
#endif
...
extern	int RefreshEffectPlayState( int AlwaysRunFlag = FALSE ) ;					// パッドエフェクトの再生状態を更新する(ソフトが非アクティブになることもあるため)
...
extern	int RefreshEffectPlayState_PF( int AlwaysRunFlag ) ;						// パッドエフェクトの再生状態を更新する関数の環境依存処理
