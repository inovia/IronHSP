...
DX_ANDROID_RENDER_BLEND_INFO g_DefaultBlendDescArray[ DX_BLENDMODE_NUM ] =
{
	...
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ONE_MINUS_DST_COLOR,	GL_ZERO,				GL_FUNC_ADD,				GL_ONE_MINUS_DST_ALPHA,	GL_ZERO,				GL_FUNC_ADD,				 TRUE },	// DX_BLENDMODE_SUB					減算ブレンド
	...
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ONE_MINUS_DST_COLOR,	GL_ZERO,				GL_FUNC_ADD,				GL_ONE_MINUS_DST_ALPHA,	GL_ZERO,				GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_INVDESTCOLOR		描画先の色の反転値を掛ける
	...
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_SRC_ALPHA,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				GL_ONE,					GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_NORMAL		Spine のブレンドモード Normal 用
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_SRC_ALPHA,			GL_ONE,					GL_FUNC_ADD,				GL_ONE,					GL_ONE,					GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_ADDITIVE		Spine のブレンドモード Additive 
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_DST_COLOR,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				GL_ONE_MINUS_SRC_ALPHA,	GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_MULTIPLY		Spine のブレンドモード Multiply 
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ONE,					GL_ONE_MINUS_SRC_COLOR,	GL_FUNC_ADD,				GL_ONE_MINUS_SRC_COLOR,	GL_ONE_MINUS_SRC_COLOR,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_SPINE_SCREEN		Spine のブレンドモード Screen 用

	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_SRC_ALPHA,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				GL_SRC_ALPHA,			GL_ONE_MINUS_SRC_ALPHA,	GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_CUSTOM				カスタムブレンド

	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ZERO,					GL_ONE,					GL_FUNC_ADD,				GL_ONE,					GL_ZERO,				GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_DST_RGB_SRC_A		描画元の A のみを書き込む( 描画先の RGB は変更されない )
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ZERO,					GL_ONE,					GL_FUNC_ADD,				GL_ONE_MINUS_DST_ALPHA,	GL_ZERO,				GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_INVDESTCOLOR_A		描画先の A の反転値を掛ける( 描画先の RGB は変更されない )
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ZERO,					GL_ONE,					GL_FUNC_ADD,				GL_ZERO,				GL_SRC_ALPHA,			GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_MUL_A				A のみの乗算ブレンド( 描画先の RGB は変更されない )
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ZERO,					GL_SRC_ALPHA,			GL_FUNC_ADD,				GL_ONE_MINUS_DST_ALPHA,	GL_ZERO,				GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_PMA_INVDESTCOLOR_A	乗算済みα用の DX_BLENDMODE_INVDESTCOLOR_A
	{ ANDROID_RENDER_TYPE_NORMAL,		TRUE,  GL_ZERO,					GL_SRC_ALPHA,			GL_FUNC_ADD,				GL_ZERO,				GL_SRC_ALPHA,			GL_FUNC_ADD,				FALSE },	// DX_BLENDMODE_PMA_MUL_A			乗算済みα用の DX_BLENDMODE_MUL_A
} ;
...
const GLchar *g_UniformName[ ANDROID_SHADER_UNIFORM_NUM ] =
{
	...
	"uAddColor",					// ANDROID_SHADER_UNIFORM_ADD_COLOR
...
extern int Graphics_Android_DeviceState_UpdateShaderUniform( GRAPHICS_ANDROID_SHADER *Shader, int LightNum, int UseLocalWorldMatrixUniformNum )
{
	...
	if( Shader->UniformIndex[ ANDROID_SHADER_UNIFORM_ADD_COLOR ] != 0xffff )
	{
		UNIFORM_SET_FLOAT4( Shader->UniformIndex[ ANDROID_SHADER_UNIFORM_ADD_COLOR ], GANDR.Device.Shader.Constant.uAddColor ) ;
	}
...
)
{
	...
	else
	{
		...
		{
			if( Graphics_Android_Texture_SetupCommonBuffer( ( unsigned int )( ImageSize * 3 ) ) < 0 )
			{
				return -1 ;
			}
...
{
	return GANDR.Device.Screen.SubBackBufferTexture ;
}
