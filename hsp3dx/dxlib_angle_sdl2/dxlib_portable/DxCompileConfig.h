...
// Desktop (Mac/Linux/Web) + SDL2 + ANGLE ビルド向けに WINDOWS_DESKTOP_OS を抑止し、
// 代わりに DX_PLATFORM_DESKTOP_SDL2 ルートを有効にする。
#ifndef DX_PLATFORM_DESKTOP_SDL2
#ifndef __APPLE__
#ifndef __ANDROID__
	#define WINDOWS_DESKTOP_OS
#endif // __ANDROID__
#endif // __APPLE__
#endif // !DX_PLATFORM_DESKTOP_SDL2

#if defined( DX_GCC_COMPILE ) || defined( __ANDROID__ ) || defined( __APPLE__ ) || defined( BC2_COMPILER ) || defined( DX_PLATFORM_DESKTOP_SDL2 )
	#define USE_ULL
#endif
...
#if defined( __ANDROID__ ) || defined( __APPLE__ ) || defined( DX_PLATFORM_DESKTOP_SDL2 )
//#define DX_NON_2DDRAW
#define DX_NON_ACM
#define DX_NON_DSHOW_MP3
#define DX_NON_DSHOW_MOVIE
