...
struct GRAPHICS_HARDDATA_DIRECT3D9_DEVICE_STATE
{
	...
	float									VerticalFogStart ;								// 高さフォグ開始距離
	float									VerticalFogEnd ;								// 高さフォグ終了距離
	float									VerticalFogDensity ;							// 高さフォグ密度
	float									VerticalFogDensityStart ;						// 高さフォグ密度開始距離
...
extern	int		Graphics_D3D9_DrawSetting_SetLightUseHalfLambert( int UseHalfLambert ) ;						// ライティング計算でハーフランバートを使用するかどうかを設定する
...
extern	int		Graphics_D3D9_DrawLineBox( int x1, int y1, int x2, int y2, unsigned int Color, int Thickness ) ;														// ハードウエアアクセラレータ使用版 DrawLineBox
...
extern	int		Graphics_Hardware_D3D9_Light_SetUseHalfLambert_PF( int UseHalfLambert ) ;										// ライトの計算でハーフランバートを使用するかどうかを設定する
