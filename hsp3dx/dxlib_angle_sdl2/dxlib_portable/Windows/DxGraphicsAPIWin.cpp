...
{
	ULONG Ret = ( ( D_IUnknown * )pObject )->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_DepthStencilView( D_ID3D11DepthStencilView *pDepthStencilView )
{
	...
	ULONG Ret = pDepthStencilView->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_InputLayout( D_ID3D11InputLayout *pInputLayout )
{
	...
	ULONG Ret = pInputLayout->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_VertexShader( D_ID3D11VertexShader *pVertexShader )
{
	...
	ULONG Ret = pVertexShader->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_GeometryShader( D_ID3D11GeometryShader *pGeometryShader )
{
	...
	ULONG Ret = pGeometryShader->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_PixelShader( D_ID3D11PixelShader *pPixelShader )
{
	...
	ULONG Ret = pPixelShader->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_DepthStencilState( D_ID3D11DepthStencilState *pDepthStencilState )
{
	...
	ULONG Ret = pDepthStencilState->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_RasterizerState( D_ID3D11RasterizerState *pRasterizerState )
{
	...
	ULONG Ret = pRasterizerState->Release() ;
	return Ret ;
}
...
extern	ULONG	Direct3D11_Release_SamplerState( D_ID3D11SamplerState *pSamplerState )
{
	...
	ULONG Ret = pSamplerState->Release() ;
	return Ret ;
}
...
extern void D3D11DeviceContext_VSSetShaderResources( UINT StartSlot, UINT NumViews,   D_ID3D11ShaderResourceView *const *ppShaderResourceViews )
{
	GAPIWin.D3D11DeviceContext->VSSetShaderResources( StartSlot, NumViews,   ppShaderResourceViews ) ;
}

extern void D3D11DeviceContext_GSSetShaderResources( UINT StartSlot, UINT NumViews,   D_ID3D11ShaderResourceView *const *ppShaderResourceViews )
{
	GAPIWin.D3D11DeviceContext->GSSetShaderResources( StartSlot, NumViews,   ppShaderResourceViews ) ;
}
