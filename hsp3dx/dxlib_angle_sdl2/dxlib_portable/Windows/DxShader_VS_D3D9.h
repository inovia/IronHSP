...
#define DX_VS_CONSTF_VERTICAL_FOG                      56			// 高さフォグ用パラメータを格納するアドレス( x:end/(end - start)  y:-1/(end - start)  z:density  w:density start )
#define DX_VS_CONSTF_VERTICAL_FOG_MODE                 57			// 高さフォグ用パラメータを格納するアドレス( x:フォグモード )
