...
//	float4 variance_md_p_pmax ;
	...
	// 法線の準備
		...
		TempF3 = ( tex2D( NormalMapTexture, PSInput.TexCoords0_1.xy ).rgb - cfZeroHalfOneTwo.y ) * cfZeroHalfOneTwo.w ;

		// テクスチャ法線をビュー空間法線に変換する
		Normal.x = TempF3.x * VTan.x + TempF3.y * VBin.x + TempF3.z * VNrm.x ;
		Normal.y = TempF3.x * VTan.y + TempF3.y * VBin.y + TempF3.z * VNrm.y ;
		Normal.z = TempF3.x * VTan.z + TempF3.y * VBin.z + TempF3.z * VNrm.z ;
...
//		lLightDot = dot( Normal, normalize( lLightTemp.xyz ) ) ;
//
//	#else // BUMPMAP
