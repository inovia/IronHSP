...
static LRESULT CALLBACK TransMes_WinForms(
	HWND hwnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	Bmscr *bm = TrackBmscr(hwnd);
	if ( bm != nullptr)
	{
		return ::CallWindowProc( bm->wfWndProc, hwnd, uMessage, wParam, lParam);
	}
