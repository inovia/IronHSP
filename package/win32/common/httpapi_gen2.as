...
#cfunc HttpAddFragmentToCache "HttpAddFragmentToCache" intptr, wstr, var, var, var
...
#cfunc HttpCancelHttpRequest "HttpCancelHttpRequest" intptr, int64, var

; uint HttpCloseRequestQueue(winmdroot.Foundation.HANDLE RequestQueueHandle)
#cfunc HttpCloseRequestQueue "HttpCloseRequestQueue" intptr

; uint HttpCloseServerSession(ulong ServerSessionId)
#cfunc HttpCloseServerSession "HttpCloseServerSession" int64

; uint HttpCloseUrlGroup(ulong UrlGroupId)
#cfunc HttpCloseUrlGroup "HttpCloseUrlGroup" int64

; uint HttpCreateHttpHandle(winmdroot.Foundation.HANDLE* RequestQueueHandle, uint Reserved)
#cfunc HttpCreateHttpHandle "HttpCreateHttpHandle" intptr, int
...
#cfunc HttpCreateRequestQueue "HttpCreateRequestQueue" var, wstr, var, int, intptr

; uint HttpCreateServerSession(winmdroot.Networking.HttpServer.HTTPAPI_VERSION Version, ulong* ServerSessionId, uint Reserved)
#cfunc HttpCreateServerSession "HttpCreateServerSession" var, var, int

; uint HttpCreateUrlGroup(ulong ServerSessionId, ulong* pUrlGroupId, uint Reserved)
#cfunc HttpCreateUrlGroup "HttpCreateUrlGroup" int64, var, int
...
#cfunc HttpDeclarePush "HttpDeclarePush" intptr, int64, int, wstr, str, var
...
#cfunc HttpDelegateRequestEx "HttpDelegateRequestEx" intptr, intptr, int64, int64, int, var
...
#cfunc HttpDeleteServiceConfiguration "HttpDeleteServiceConfiguration" intptr, int, intptr, int, var
...
#cfunc HttpFindUrlGroupId "HttpFindUrlGroupId" wstr, intptr, var
...
#cfunc HttpFlushResponseCache "HttpFlushResponseCache" intptr, wstr, int, var

; uint HttpGetExtension(winmdroot.Networking.HttpServer.HTTPAPI_VERSION Version, uint Extension, void* Buffer, uint BufferSize)
#cfunc HttpGetExtension "HttpGetExtension" var, int, intptr, int
...
#cfunc HttpPrepareUrl "HttpPrepareUrl" intptr, int, wstr, var
...
#cfunc HttpQueryRequestQueueProperty "HttpQueryRequestQueueProperty" intptr, int, intptr, int, int, var, intptr
...
#cfunc HttpQueryServerSessionProperty "HttpQueryServerSessionProperty" int64, int, intptr, int, var
...
#cfunc HttpQueryServiceConfiguration "HttpQueryServiceConfiguration" intptr, int, intptr, int, intptr, int, var, var
...
#cfunc HttpQueryUrlGroupProperty "HttpQueryUrlGroupProperty" int64, int, intptr, int, var
...
#cfunc HttpReadFragmentFromCache "HttpReadFragmentFromCache" intptr, wstr, var, intptr, int, var, var
...
#cfunc HttpReceiveClientCertificate "HttpReceiveClientCertificate" intptr, int64, int, var, int, var, var
...
#cfunc HttpReceiveHttpRequest "HttpReceiveHttpRequest" intptr, int64, int, var, int, var, var
...
#cfunc HttpReceiveRequestEntityBody "HttpReceiveRequestEntityBody" intptr, int64, int, intptr, int, var, var

; uint HttpRemoveUrl(winmdroot.Foundation.HANDLE RequestQueueHandle, winmdroot.Foundation.PCWSTR FullyQualifiedUrl)
#cfunc HttpRemoveUrl "HttpRemoveUrl" intptr, wstr

; uint HttpRemoveUrlFromUrlGroup(ulong UrlGroupId, winmdroot.Foundation.PCWSTR pFullyQualifiedUrl, uint Flags)
#cfunc HttpRemoveUrlFromUrlGroup "HttpRemoveUrlFromUrlGroup" int64, wstr, int
...
#cfunc HttpSendHttpResponse "HttpSendHttpResponse" intptr, int64, int, var, var, var, intptr, int, var, var
...
#cfunc HttpSendResponseEntityBody "HttpSendResponseEntityBody" intptr, int64, int, int, var, var, intptr, int, var, var
...
#cfunc HttpSetRequestQueueProperty "HttpSetRequestQueueProperty" intptr, int, intptr, int, int, intptr
...
#cfunc HttpSetServerSessionProperty "HttpSetServerSessionProperty" int64, int, intptr, int
...
#cfunc HttpSetServiceConfiguration "HttpSetServiceConfiguration" intptr, int, intptr, int, var
...
#cfunc HttpSetUrlGroupProperty "HttpSetUrlGroupProperty" int64, int, intptr, int

; uint HttpShutdownRequestQueue(winmdroot.Foundation.HANDLE RequestQueueHandle)
#cfunc HttpShutdownRequestQueue "HttpShutdownRequestQueue" intptr

; uint HttpTerminate(winmdroot.Networking.HttpServer.HTTP_INITIALIZE Flags, [Optional] void* pReserved)
#cfunc HttpTerminate "HttpTerminate" int, intptr
...
#cfunc HttpUpdateServiceConfiguration "HttpUpdateServiceConfiguration" intptr, int, intptr, int, var
...
#cfunc HttpWaitForDemandStart "HttpWaitForDemandStart" intptr, var
...
#cfunc HttpWaitForDisconnect "HttpWaitForDisconnect" intptr, int64, var
...
#cfunc HttpWaitForDisconnectEx "HttpWaitForDisconnectEx" intptr, int64, int, var
