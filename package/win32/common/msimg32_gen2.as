...
#define global __msimg32_gen2_as__
...
#cfunc global AlphaBlend "AlphaBlend" intptr, int, int, int, int, intptr, int, int, int, int, var
...
#cfunc global GradientFill "GradientFill" intptr, var, int, intptr, int, int
