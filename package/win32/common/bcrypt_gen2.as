...
#define global __bcrypt_gen2_as__
...
#cfunc global BCryptCloseAlgorithmProvider "BCryptCloseAlgorithmProvider" int, int
...
#cfunc global BCryptConfigureContext "BCryptConfigureContext" int, wstr, var
...
#cfunc global BCryptConfigureContextFunction "BCryptConfigureContextFunction" int, wstr, int, wstr, var
...
#cfunc global BCryptCreateContext "BCryptCreateContext" int, wstr, var
...
#cfunc global BCryptCreateHash "BCryptCreateHash" int, var, var, int, var, int, int
...
#cfunc global BCryptCreateMultiHash "BCryptCreateMultiHash" int, var, int, var, int, var, int, int
...
#cfunc global BCryptDecrypt "BCryptDecrypt" int, var, int, intptr, var, int, var, int, var, int
...
#cfunc global BCryptDestroySecret "BCryptDestroySecret" int
...
#cfunc global BCryptDeriveKey "BCryptDeriveKey" int, wstr, var, var, int, var, int
...
#cfunc global BCryptDeriveKeyCapi "BCryptDeriveKeyCapi" int, int, var, int, int
...
#cfunc global BCryptDeriveKeyPBKDF2 "BCryptDeriveKeyPBKDF2" int, var, int, var, int, int64, var, int, int
...
#cfunc global BCryptDuplicateHash "BCryptDuplicateHash" int, var, var, int, int
...
#cfunc global BCryptDuplicateKey "BCryptDuplicateKey" int, var, var, int, int
...
#cfunc global BCryptEncrypt "BCryptEncrypt" int, var, int, intptr, var, int, var, int, var, int
...
#cfunc global BCryptEnumAlgorithms "BCryptEnumAlgorithms" int, var, var, int
...
#cfunc global BCryptEnumContextFunctionProviders "BCryptEnumContextFunctionProviders" int, wstr, int, wstr, var, var
...
#cfunc global BCryptEnumContextFunctions "BCryptEnumContextFunctions" int, wstr, int, var, var
...
#cfunc global BCryptEnumProviders "BCryptEnumProviders" wstr, var, var, int
...
#cfunc global BCryptEnumRegisteredProviders "BCryptEnumRegisteredProviders" var, var
...
#cfunc global BCryptExportKey "BCryptExportKey" int, int, wstr, var, int, var, int

; winmdroot.Foundation.NTSTATUS BCryptFinalizeKeyPair(winmdroot.Security.Cryptography.BCRYPT_KEY_HANDLE hKey, uint dwFlags)
#cfunc global BCryptFinalizeKeyPair "BCryptFinalizeKeyPair" int, int
...
#cfunc global BCryptFinishHash "BCryptFinishHash" int, var, int, int

; void BCryptFreeBuffer(void* pvBuffer)
#func global BCryptFreeBuffer "BCryptFreeBuffer" intptr
...
#cfunc global BCryptGenRandom "BCryptGenRandom" int, var, int, int
...
#cfunc global BCryptGenerateKeyPair "BCryptGenerateKeyPair" int, var, int, int
...
#cfunc global BCryptGenerateSymmetricKey "BCryptGenerateSymmetricKey" int, var, var, int, var, int, int
...
#cfunc global BCryptGetProperty "BCryptGetProperty" int, wstr, var, int, var, int
...
#cfunc global BCryptHash "BCryptHash" int, var, int, var, int, var, int
...
#cfunc global BCryptHashData "BCryptHashData" int, var, int, int
...
#cfunc global BCryptImportKey "BCryptImportKey" int, int, wstr, var, var, int, var, int, int
...
#cfunc global BCryptImportKeyPair "BCryptImportKeyPair" int, int, wstr, var, var, int, int
...
#cfunc global BCryptKeyDerivation "BCryptKeyDerivation" int, var, var, int, var, int
...
#cfunc global BCryptOpenAlgorithmProvider "BCryptOpenAlgorithmProvider" var, wstr, wstr, int
...
#cfunc global BCryptProcessMultiOperations "BCryptProcessMultiOperations" int, int, intptr, int, int
...
#cfunc global BCryptQueryContextFunctionConfiguration "BCryptQueryContextFunctionConfiguration" int, wstr, int, wstr, var, var
...
#cfunc global BCryptQueryContextFunctionProperty "BCryptQueryContextFunctionProperty" int, wstr, int, wstr, wstr, var, var
...
#cfunc global BCryptQueryProviderRegistration "BCryptQueryProviderRegistration" wstr, int, int, var, var
...
#cfunc global BCryptRemoveContextFunction "BCryptRemoveContextFunction" int, wstr, int, wstr
...
#cfunc global BCryptResolveProviders "BCryptResolveProviders" wstr, int, wstr, wstr, int, int, var, var
...
#cfunc global BCryptSecretAgreement "BCryptSecretAgreement" int, int, var, int
...
#cfunc global BCryptSetProperty "BCryptSetProperty" int, wstr, var, int, int
...
#cfunc global BCryptSignHash "BCryptSignHash" int, intptr, var, int, var, int, var, int
...
#cfunc global BCryptVerifySignature "BCryptVerifySignature" int, intptr, var, int, var, int, int
