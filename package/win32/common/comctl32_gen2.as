...
#cfunc DestroyPropertySheetPage "DestroyPropertySheetPage" intptr
...
#cfunc CreateMappedBitmap "CreateMappedBitmap" intptr, int, int, var, int
...
#cfunc CreatePropertySheetPageW "CreatePropertySheetPageW" var
...
#cfunc CreateStatusWindowW "CreateStatusWindowW" int, wstr, intptr, int
...
#cfunc DPA_LoadStream "DPA_LoadStream" intptr, int, var, intptr
...
#cfunc DPA_Merge "DPA_Merge" intptr, intptr, int, int, int, intptr
...
#cfunc DPA_SaveStream "DPA_SaveStream" intptr, int, var, intptr
...
#cfunc DPA_Search "DPA_Search" intptr, intptr, int, int, intptr, int

; winmdroot.Foundation.BOOL DPA_SetPtr(winmdroot.UI.Controls.HDPA hdpa, int i, [Optional] void* p)
#cfunc DPA_SetPtr "DPA_SetPtr" intptr, int, intptr
...
#cfunc DefSubclassProc "DefSubclassProc" intptr, int, intptr, intptr

; void DrawInsert(winmdroot.Foundation.HWND handParent, winmdroot.Foundation.HWND hLB, int nItem)
#func DrawInsert "DrawInsert" intptr, intptr, int
...
#func DrawStatusTextW "DrawStatusTextW" intptr, var, wstr, int

; winmdroot.Foundation.BOOL FlatSB_EnableScrollBar(winmdroot.Foundation.HWND param0, int param1, uint param2)
#cfunc FlatSB_EnableScrollBar "FlatSB_EnableScrollBar" intptr, int, int
...
#cfunc FlatSB_GetScrollInfo "FlatSB_GetScrollInfo" intptr, int, var

; int FlatSB_GetScrollPos(winmdroot.Foundation.HWND param0, winmdroot.UI.WindowsAndMessaging.SCROLLBAR_CONSTANTS code)
#cfunc FlatSB_GetScrollPos "FlatSB_GetScrollPos" intptr, int
...
#cfunc FlatSB_GetScrollProp "FlatSB_GetScrollProp" intptr, int, var
...
#cfunc FlatSB_GetScrollRange "FlatSB_GetScrollRange" intptr, int, var, var
...
#cfunc FlatSB_SetScrollInfo "FlatSB_SetScrollInfo" intptr, int, var, int
...
#cfunc FlatSB_SetScrollPos "FlatSB_SetScrollPos" intptr, int, int, int
...
#cfunc FlatSB_SetScrollProp "FlatSB_SetScrollProp" intptr, int, int, int
...
#cfunc FlatSB_SetScrollRange "FlatSB_SetScrollRange" intptr, int, int, int, int
...
#cfunc FlatSB_ShowScrollBar "FlatSB_ShowScrollBar" intptr, int, int

; void GetEffectiveClientRect(winmdroot.Foundation.HWND hWnd, winmdroot.Foundation.RECT* lprc, int* lpInfo)
#func GetEffectiveClientRect "GetEffectiveClientRect" intptr, var, var

; ushort GetMUILanguage()
#cfunc GetMUILanguage "GetMUILanguage"
...
#cfunc ImageList_AddMasked "ImageList_AddMasked" intptr, intptr, int
...
#cfunc ImageList_BeginDrag "ImageList_BeginDrag" intptr, int, int, int
...
#cfunc ImageList_Copy "ImageList_Copy" intptr, int, intptr, int, int
...
#cfunc ImageList_DragEnter "ImageList_DragEnter" intptr, int, int

; winmdroot.Foundation.BOOL ImageList_DragLeave(winmdroot.Foundation.HWND hwndLock)
#cfunc ImageList_DragLeave "ImageList_DragLeave" intptr

; winmdroot.Foundation.BOOL ImageList_DragMove(int x, int y)
#cfunc ImageList_DragMove "ImageList_DragMove" int, int

; winmdroot.Foundation.BOOL ImageList_DragShowNolock(winmdroot.Foundation.BOOL fShow)
#cfunc ImageList_DragShowNolock "ImageList_DragShowNolock" int
...
#cfunc ImageList_DrawEx "ImageList_DrawEx" intptr, int, intptr, int, int, int, int, int, int, int

; winmdroot.Foundation.BOOL ImageList_DrawIndirect(winmdroot.UI.Controls.IMAGELISTDRAWPARAMS* pimldp)
#cfunc ImageList_DrawIndirect "ImageList_DrawIndirect" var

; winmdroot.UI.Controls.HIMAGELIST ImageList_Duplicate(winmdroot.UI.Controls.HIMAGELIST himl)
#cfunc ImageList_Duplicate "ImageList_Duplicate" intptr
...
#cfunc ImageList_GetBkColor "ImageList_GetBkColor" intptr
...
#cfunc ImageList_GetDragImage "ImageList_GetDragImage" var, var
...
#cfunc ImageList_GetIcon "ImageList_GetIcon" intptr, int, int

; winmdroot.Foundation.BOOL ImageList_GetIconSize(winmdroot.UI.Controls.HIMAGELIST himl, [Optional] int* cx, [Optional] int* cy)
#cfunc ImageList_GetIconSize "ImageList_GetIconSize" intptr, var, var
...
#cfunc ImageList_GetImageInfo "ImageList_GetImageInfo" intptr, int, var
...
#cfunc ImageList_LoadImageW "ImageList_LoadImageW" intptr, wstr, int, int, int, int, int
...
#cfunc ImageList_Replace "ImageList_Replace" intptr, int, intptr, intptr

; int ImageList_ReplaceIcon(winmdroot.UI.Controls.HIMAGELIST himl, int i, winmdroot.UI.WindowsAndMessaging.HICON hicon)
#cfunc ImageList_ReplaceIcon "ImageList_ReplaceIcon" intptr, int, intptr
...
#cfunc ImageList_SetBkColor "ImageList_SetBkColor" intptr, int
...
#func MenuHelp "MenuHelp" int, intptr, intptr, intptr, intptr, intptr, var

; nint PropertySheet(winmdroot.UI.Controls.PROPSHEETHEADERW_V2* param0)
#cfunc PropertySheetW "PropertySheetW" var
...
#cfunc RemoveWindowSubclass "RemoveWindowSubclass" intptr, int, int
