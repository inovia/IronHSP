...
#define global __wininet_gen2_as__
...
#cfunc global AppCacheCheckManifest "AppCacheCheckManifest" wstr, wstr, var, int, var, int, var, var

; void AppCacheCloseHandle(void* hAppCache)
#func global AppCacheCloseHandle "AppCacheCloseHandle" intptr
...
#cfunc global AppCacheCreateAndCommitFile "AppCacheCreateAndCommitFile" intptr, wstr, wstr, var, int

; uint AppCacheDeleteGroup(winmdroot.Foundation.PCWSTR pwszManifestUrl)
#cfunc global AppCacheDeleteGroup "AppCacheDeleteGroup" wstr
...
#cfunc global AppCacheDuplicateHandle "AppCacheDuplicateHandle" intptr, var
...
#cfunc global AppCacheLookup "AppCacheLookup" wstr, int, var
...
#cfunc global CommitUrlCacheEntryW "CommitUrlCacheEntryW" wstr, wstr, int, int, int, wstr, int, wstr, wstr
...
#cfunc global CommitUrlCacheEntryBinaryBlob "CommitUrlCacheEntryBinaryBlob" wstr, int, int, int, var, int
...
#cfunc global CreateMD5SSOHash "CreateMD5SSOHash" wstr, wstr, wstr, var
...
#cfunc global CreateUrlCacheEntryW "CreateUrlCacheEntryW" wstr, int, wstr, wstr, int
...
#cfunc global CreateUrlCacheEntryExW "CreateUrlCacheEntryExW" wstr, int, wstr, wstr, int, int

; long CreateUrlCacheGroup(uint dwFlags, [Optional] void* lpReserved)
#cfunc global CreateUrlCacheGroup "CreateUrlCacheGroup" int, intptr
...
#cfunc global DetectAutoProxyUrl "DetectAutoProxyUrl" str, int, int

; winmdroot.Foundation.BOOL FindCloseUrlCache(winmdroot.Foundation.HANDLE hEnumHandle)
#cfunc global FindCloseUrlCache "FindCloseUrlCache" intptr
...
#cfunc global FindFirstUrlCacheContainerW "FindFirstUrlCacheContainerW" var, var, var, int
...
#cfunc global FindFirstUrlCacheGroup "FindFirstUrlCacheGroup" int, int, intptr, int, var, intptr
...
#cfunc global FindNextUrlCacheContainerW "FindNextUrlCacheContainerW" intptr, var, var
...
#cfunc global FindNextUrlCacheEntryW "FindNextUrlCacheEntryW" intptr, var, var
...
#cfunc global FindNextUrlCacheEntryExW "FindNextUrlCacheEntryExW" intptr, var, var, intptr, var, intptr
...
#cfunc global FindNextUrlCacheGroup "FindNextUrlCacheGroup" intptr, var, intptr
...
#cfunc global FtpCommandW "FtpCommandW" intptr, int, int, wstr, int, var

; winmdroot.Foundation.BOOL FtpCreateDirectory(void* hConnect, winmdroot.Foundation.PCWSTR lpszDirectory)
#cfunc global FtpCreateDirectoryW "FtpCreateDirectoryW" intptr, wstr
...
#cfunc global FtpFindFirstFileW "FtpFindFirstFileW" intptr, wstr, var, int, int
...
#cfunc global FtpGetCurrentDirectoryW "FtpGetCurrentDirectoryW" intptr, wstr, var
...
#cfunc global FtpGetFileW "FtpGetFileW" intptr, wstr, wstr, int, int, int, int
...
#cfunc global FtpGetFileEx "FtpGetFileEx" intptr, str, wstr, int, int, int, int

; uint FtpGetFileSize(void* hFile, [Optional] uint* lpdwFileSizeHigh)
#cfunc global FtpGetFileSize "FtpGetFileSize" intptr, var
...
#cfunc global FtpOpenFileW "FtpOpenFileW" intptr, wstr, int, int, int
...
#cfunc global FtpPutFileW "FtpPutFileW" intptr, wstr, wstr, int, int
...
#cfunc global FtpPutFileEx "FtpPutFileEx" intptr, wstr, str, int, int

; winmdroot.Foundation.BOOL FtpRemoveDirectory(void* hConnect, winmdroot.Foundation.PCWSTR lpszDirectory)
#cfunc global FtpRemoveDirectoryW "FtpRemoveDirectoryW" intptr, wstr
...
#cfunc global GetUrlCacheConfigInfoW "GetUrlCacheConfigInfoW" var, var, int
...
#cfunc global GetUrlCacheEntryInfoW "GetUrlCacheEntryInfoW" wstr, var, var
...
#cfunc global GetUrlCacheEntryInfoExW "GetUrlCacheEntryInfoExW" wstr, var, var, wstr, var, intptr, int
...
#cfunc global GetUrlCacheGroupAttributeW "GetUrlCacheGroupAttributeW" int64, int, int, var, var, intptr

; winmdroot.Foundation.BOOL GetUrlCacheHeaderData(uint nIdx, uint* lpdwData)
#cfunc global GetUrlCacheHeaderData "GetUrlCacheHeaderData" int, var
...
#cfunc global GopherCreateLocatorW "GopherCreateLocatorW" wstr, int, wstr, wstr, int, wstr, var
...
#cfunc global GopherFindFirstFileW "GopherFindFirstFileW" intptr, wstr, wstr, var, int, int
...
#cfunc global GopherGetAttributeW "GopherGetAttributeW" intptr, wstr, wstr, var, int, var, int, int
...
#cfunc global GopherOpenFileW "GopherOpenFileW" intptr, wstr, wstr, int, int
...
#cfunc global HttpCheckDavComplianceW "HttpCheckDavComplianceW" wstr, wstr, var, intptr, intptr

; void HttpCloseDependencyHandle(void* hDependencyHandle)
#func global HttpCloseDependencyHandle "HttpCloseDependencyHandle" intptr

; uint HttpDuplicateDependencyHandle(void* hDependencyHandle, void** phDuplicatedDependencyHandle)
#cfunc global HttpDuplicateDependencyHandle "HttpDuplicateDependencyHandle" intptr, var
...
#cfunc global HttpEndRequestW "HttpEndRequestW" intptr, var, int, int
...
#cfunc global HttpGetServerCredentials "HttpGetServerCredentials" wstr, var, var

; uint HttpIndicatePageLoadComplete(void* hDependencyHandle)
#cfunc global HttpIndicatePageLoadComplete "HttpIndicatePageLoadComplete" intptr

; uint HttpIsHostHstsEnabled(winmdroot.Foundation.PCWSTR pcwszUrl, winmdroot.Foundation.BOOL* pfIsHsts)
#cfunc global HttpIsHostHstsEnabled "HttpIsHostHstsEnabled" wstr, var

; uint HttpOpenDependencyHandle(void* hRequestHandle, winmdroot.Foundation.BOOL fBackground, void** phDependencyHandle)
#cfunc global HttpOpenDependencyHandle "HttpOpenDependencyHandle" intptr, int, var
...
#cfunc global HttpOpenRequestW "HttpOpenRequestW" intptr, wstr, wstr, wstr, wstr, var, int, int

; void HttpPushClose(winmdroot.Networking.WinInet.HTTP_PUSH_WAIT_HANDLE hWait)
#func global HttpPushClose "HttpPushClose" intptr
...
#cfunc global HttpPushEnable "HttpPushEnable" intptr, var, intptr
...
#cfunc global HttpPushWait "HttpPushWait" intptr, int, var
...
#cfunc global HttpSendRequestExW "HttpSendRequestExW" intptr, var, var, int, int

; winmdroot.Foundation.BOOL HttpWebSocketClose(void* hWebSocket, ushort usStatus, [Optional] void* pvReason, uint dwReasonLength)
#cfunc global HttpWebSocketClose "HttpWebSocketClose" intptr, int, intptr, int

; void* HttpWebSocketCompleteUpgrade(void* hRequest, nuint dwContext)
#cfunc global HttpWebSocketCompleteUpgrade "HttpWebSocketCompleteUpgrade" intptr, int
...
#cfunc global HttpWebSocketQueryCloseStatus "HttpWebSocketQueryCloseStatus" intptr, var, intptr, int, var
...
#cfunc global HttpWebSocketReceive "HttpWebSocketReceive" intptr, intptr, int, var, var
...
#cfunc global HttpWebSocketSend "HttpWebSocketSend" intptr, int, intptr, int
...
#cfunc global HttpWebSocketShutdown "HttpWebSocketShutdown" intptr, int, intptr, int

; winmdroot.Foundation.BOOL IncrementUrlCacheHeaderData(uint nIdx, uint* lpdwData)
#cfunc global IncrementUrlCacheHeaderData "IncrementUrlCacheHeaderData" int, var
...
#cfunc global InternetAlgIdToStringW "InternetAlgIdToStringW" int, wstr, var, int

; uint InternetAttemptConnect(uint dwReserved)
#cfunc global InternetAttemptConnect "InternetAttemptConnect" int
...
#cfunc global InternetAutodial "InternetAutodial" int, intptr

; winmdroot.Foundation.BOOL InternetAutodialHangup(uint dwReserved)
#cfunc global InternetAutodialHangup "InternetAutodialHangup" int
...
#cfunc global InternetCanonicalizeUrlW "InternetCanonicalizeUrlW" wstr, wstr, var, int
...
#cfunc global InternetClearAllPerSiteCookieDecisions "InternetClearAllPerSiteCookieDecisions"
...
#cfunc global InternetCombineUrlW "InternetCombineUrlW" wstr, wstr, wstr, var, int
...
#cfunc global InternetConnectW "InternetConnectW" intptr, wstr, int, wstr, wstr, int, int, int
...
#cfunc global InternetConvertUrlFromWireToWideChar "InternetConvertUrlFromWireToWideChar" str, int, wstr, int, int, int, int, var
...
#cfunc global InternetCrackUrlW "InternetCrackUrlW" wstr, int, int, var
...
#cfunc global InternetCreateUrlW "InternetCreateUrlW" var, int, wstr, var
...
#cfunc global InternetDial "InternetDial" intptr, str, int, var, int
...
#cfunc global InternetEnumPerSiteCookieDecisionW "InternetEnumPerSiteCookieDecisionW" wstr, var, var, int
...
#cfunc global InternetGetConnectedState "InternetGetConnectedState" var, int
...
#cfunc global InternetGetConnectedStateEx "InternetGetConnectedStateEx" var, str, int, int
...
#cfunc global InternetGetCookieW "InternetGetCookieW" wstr, wstr, wstr, var
...
#cfunc global InternetGetCookieExW "InternetGetCookieExW" wstr, wstr, wstr, var, int, intptr
...
#cfunc global InternetGetCookieEx2 "InternetGetCookieEx2" wstr, wstr, int, var, var
...
#cfunc global InternetGetLastResponseInfoW "InternetGetLastResponseInfoW" var, wstr, var

; winmdroot.Foundation.BOOL InternetGetPerSiteCookieDecisionW(winmdroot.Foundation.PCWSTR pchHostName, uint* pResult)
#cfunc global InternetGetPerSiteCookieDecisionW "InternetGetPerSiteCookieDecisionW" wstr, var
...
#cfunc global InternetGetProxyForUrl "InternetGetProxyForUrl" intptr, wstr, var
...
#cfunc global InternetGetSecurityInfoByURL "InternetGetSecurityInfoByURL" str, var, var
...
#cfunc global InternetGetSecurityInfoByURLA "InternetGetSecurityInfoByURLA" str, var, var
...
#cfunc global InternetGetSecurityInfoByURLW "InternetGetSecurityInfoByURLW" wstr, var, var
...
#cfunc global InternetGoOnline "InternetGoOnline" str, intptr, int

; uint InternetHangUp(nuint dwConnection, uint dwReserved)
#cfunc global InternetHangUp "InternetHangUp" int, int

; winmdroot.Foundation.BOOL InternetInitializeAutoProxyDll(uint dwReserved)
#cfunc global InternetInitializeAutoProxyDll "InternetInitializeAutoProxyDll" int
...
#cfunc global InternetOpenW "InternetOpenW" wstr, int, wstr, wstr, int
...
#cfunc global InternetOpenUrlW "InternetOpenUrlW" intptr, wstr, wstr, int, int, int
...
#cfunc global InternetQueryDataAvailable "InternetQueryDataAvailable" intptr, var, int, int

; winmdroot.Foundation.BOOL InternetQueryFortezzaStatus(uint* pdwStatus, nuint dwReserved)
#cfunc global InternetQueryFortezzaStatus "InternetQueryFortezzaStatus" var, int
...
#cfunc global InternetReadFileExW "InternetReadFileExW" intptr, var, int, int
...
#cfunc global InternetSecurityProtocolToStringW "InternetSecurityProtocolToStringW" int, wstr, var, int
...
#cfunc global InternetSetCookieW "InternetSetCookieW" wstr, wstr, wstr
...
#cfunc global InternetSetCookieExW "InternetSetCookieExW" wstr, wstr, wstr, int, int
...
#cfunc global InternetSetCookieEx2 "InternetSetCookieEx2" wstr, var, wstr, int, var

; winmdroot.Foundation.BOOL InternetSetDialState(winmdroot.Foundation.PCSTR lpszConnectoid, uint dwState, uint dwReserved)
#cfunc global InternetSetDialState "InternetSetDialState" str, int, int
...
#cfunc global InternetSetFilePointer "InternetSetFilePointer" intptr, int, var, int, int
...
#cfunc global InternetSetPerSiteCookieDecisionW "InternetSetPerSiteCookieDecisionW" wstr, int
...
#cfunc global InternetTimeFromSystemTime "InternetTimeFromSystemTime" var, int, str, int
...
#cfunc global InternetTimeToSystemTime "InternetTimeToSystemTime" str, var, int
...
#cfunc global InternetWriteFileExW "InternetWriteFileExW" intptr, var, int, int
...
#cfunc global IsHostInProxyBypassList "IsHostInProxyBypassList" int, str, int
...
#cfunc global IsUrlCacheEntryExpiredW "IsUrlCacheEntryExpiredW" wstr, int, var

; winmdroot.Foundation.BOOL LoadUrlCacheContent()
#cfunc global LoadUrlCacheContent "LoadUrlCacheContent"
...
#cfunc global ParseX509EncodedCertificateForListBoxEntry "ParseX509EncodedCertificateForListBoxEntry" var, int, str, var
...
#cfunc global PrivacyGetZonePreferenceW "PrivacyGetZonePreferenceW" int, int, var, wstr, var
...
#cfunc global ReadUrlCacheEntryStream "ReadUrlCacheEntryStream" intptr, int, intptr, var, int
...
#cfunc global ReadUrlCacheEntryStreamEx "ReadUrlCacheEntryStreamEx" intptr, int64, intptr, var
...
#cfunc global ResumeSuspendedDownload "ResumeSuspendedDownload" intptr, int
...
#cfunc global SetUrlCacheConfigInfoW "SetUrlCacheConfigInfoW" var, int
...
#cfunc global SetUrlCacheEntryGroup "SetUrlCacheEntryGroup" str, int, int64, var, int, intptr
...
#cfunc global SetUrlCacheEntryInfoW "SetUrlCacheEntryInfoW" wstr, var, int
...
#cfunc global SetUrlCacheGroupAttributeW "SetUrlCacheGroupAttributeW" int64, int, int, var, intptr

; winmdroot.Foundation.BOOL SetUrlCacheHeaderData(uint nIdx, uint dwData)
#cfunc global SetUrlCacheHeaderData "SetUrlCacheHeaderData" int, int
...
#cfunc global ShowX509EncodedCertificate "ShowX509EncodedCertificate" intptr, var, int

; winmdroot.Foundation.BOOL UnlockUrlCacheEntryFile(winmdroot.Foundation.PCSTR lpszUrlName, uint dwReserved)
#cfunc global UnlockUrlCacheEntryFile "UnlockUrlCacheEntryFile" str, int

; winmdroot.Foundation.BOOL UnlockUrlCacheEntryStream(winmdroot.Foundation.HANDLE hUrlCacheStream, uint Reserved)
#cfunc global UnlockUrlCacheEntryStream "UnlockUrlCacheEntryStream" intptr, int
...
#cfunc global UrlCacheCheckEntriesExist "UrlCacheCheckEntriesExist" var, int, var
...
#cfunc global UrlCacheContainerSetEntryMaximumAge "UrlCacheContainerSetEntryMaximumAge" wstr, int
...
#cfunc global UrlCacheCreateContainer "UrlCacheCreateContainer" wstr, wstr, wstr, int64, int
...
#cfunc global UrlCacheFindFirstEntry "UrlCacheFindFirstEntry" wstr, int, int, int64, var, intptr
...
#cfunc global UrlCacheFindNextEntry "UrlCacheFindNextEntry" intptr, var

; void UrlCacheFreeEntryInfo(winmdroot.Networking.WinInet.URLCACHE_ENTRY_INFO* pCacheEntryInfo)
#func global UrlCacheFreeEntryInfo "UrlCacheFreeEntryInfo" var

; uint UrlCacheFreeGlobalSpace(ulong ullTargetSize, uint dwFilter)
#cfunc global UrlCacheFreeGlobalSpace "UrlCacheFreeGlobalSpace" int64, int

; uint UrlCacheGetContentPaths(winmdroot.Foundation.PWSTR** pppwszDirectories, uint* pcDirectories)
#cfunc global UrlCacheGetContentPaths "UrlCacheGetContentPaths" var, var
...
#cfunc global UrlCacheGetGlobalCacheSize "UrlCacheGetGlobalCacheSize" int, var, var

; uint UrlCacheGetGlobalLimit(winmdroot.Networking.WinInet.URL_CACHE_LIMIT_TYPE limitType, ulong* pullLimit)
#cfunc global UrlCacheGetGlobalLimit "UrlCacheGetGlobalLimit" int, var

; uint UrlCacheReadEntryStream(void* hUrlCacheStream, ulong ullLocation, void* pBuffer, uint dwBufferLen, uint* pdwBufferLen)
#cfunc global UrlCacheReadEntryStream "UrlCacheReadEntryStream" intptr, int64, intptr, int, var

; uint UrlCacheReloadSettings()
#cfunc global UrlCacheReloadSettings "UrlCacheReloadSettings"
...
#cfunc global UrlCacheRetrieveEntryFile "UrlCacheRetrieveEntryFile" intptr, wstr, var, var
...
#cfunc global UrlCacheRetrieveEntryStream "UrlCacheRetrieveEntryStream" intptr, wstr, int, var, var

; uint UrlCacheServer()
#cfunc global UrlCacheServer "UrlCacheServer"

; uint UrlCacheSetGlobalLimit(winmdroot.Networking.WinInet.URL_CACHE_LIMIT_TYPE limitType, ulong ullLimit)
#cfunc global UrlCacheSetGlobalLimit "UrlCacheSetGlobalLimit" int, int64
...
#cfunc global UrlCacheUpdateEntryExtraData "UrlCacheUpdateEntryExtraData" intptr, wstr, var, int
