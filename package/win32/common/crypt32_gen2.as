...
#cfunc CertAddCRLContextToStore "CertAddCRLContextToStore" int, var, int, var
...
#cfunc CertAddCRLLinkToStore "CertAddCRLLinkToStore" int, var, int, var
...
#cfunc CertAddCTLContextToStore "CertAddCTLContextToStore" int, var, int, var
...
#cfunc CertAddCTLLinkToStore "CertAddCTLLinkToStore" int, var, int, var
...
#cfunc CertAddCertificateContextToStore "CertAddCertificateContextToStore" int, var, int, var
...
#cfunc CertAddCertificateLinkToStore "CertAddCertificateLinkToStore" int, var, int, var
...
#cfunc CertAddEncodedCRLToStore "CertAddEncodedCRLToStore" int, int, var, int, int, var
...
#cfunc CertAddEncodedCTLToStore "CertAddEncodedCTLToStore" int, int, var, int, int, var
...
#cfunc CertAddEncodedCertificateToStore "CertAddEncodedCertificateToStore" int, int, var, int, int, var
...
#cfunc CertAddEncodedCertificateToSystemStoreW "CertAddEncodedCertificateToSystemStoreW" wstr, var, int
...
#cfunc CertAddEnhancedKeyUsageIdentifier "CertAddEnhancedKeyUsageIdentifier" var, str

; void CertAddRefServerOcspResponse([Optional] void* hServerOcspResponse)
#func CertAddRefServerOcspResponse "CertAddRefServerOcspResponse" intptr
...
#func CertAddRefServerOcspResponseContext "CertAddRefServerOcspResponseContext" var
...
#cfunc CertAddSerializedElementToStore "CertAddSerializedElementToStore" int, var, int, int, int, int, var, var
...
#cfunc CertAddStoreToCollection "CertAddStoreToCollection" int, int, int, int

; winmdroot.Foundation.PCSTR CertAlgIdToOID(uint dwAlgId)
#cfunc CertAlgIdToOID "CertAlgIdToOID" int

; void CertCloseServerOcspResponse([Optional] void* hServerOcspResponse, uint dwFlags)
#func CertCloseServerOcspResponse "CertCloseServerOcspResponse" intptr, int
...
#cfunc CertCompareCertificate "CertCompareCertificate" int, var, var
...
#cfunc CertCompareCertificateName "CertCompareCertificateName" int, var, var
...
#cfunc CertCompareIntegerBlob "CertCompareIntegerBlob" var, var
...
#cfunc CertComparePublicKeyInfo "CertComparePublicKeyInfo" int, var, var
...
#cfunc CertControlStore "CertControlStore" int, int, int, intptr
...
#cfunc CertCreateCRLContext "CertCreateCRLContext" int, var, int
...
#cfunc CertCreateCTLContext "CertCreateCTLContext" int, var, int
...
#cfunc CertCreateCTLEntryFromCertificateContextProperties "CertCreateCTLEntryFromCertificateContextProperties" var, int, var, int, intptr, var, var

; void CertFreeCertificateChainEngine(winmdroot.Security.Cryptography.HCERTCHAINENGINE hChainEngine)
#func CertFreeCertificateChainEngine "CertFreeCertificateChainEngine" intptr
...
#cfunc CertCreateCertificateChainEngine "CertCreateCertificateChainEngine" var, intptr
...
#cfunc CertCreateCertificateContext "CertCreateCertificateContext" int, var, int
...
#cfunc CertCreateContext "CertCreateContext" int, int, var, int, int, var
...
#cfunc CertDuplicateCRLContext "CertDuplicateCRLContext" var
...
#cfunc CertDuplicateCTLContext "CertDuplicateCTLContext" var
...
#cfunc CertDuplicateCertificateChain "CertDuplicateCertificateChain" var
...
#cfunc CertEnumCRLsInStore "CertEnumCRLsInStore" int, var

; uint CertEnumCTLContextProperties(winmdroot.Security.Cryptography.CTL_CONTEXT* pCtlContext, uint dwPropId)
#cfunc CertEnumCTLContextProperties "CertEnumCTLContextProperties" var, int
...
#cfunc CertEnumCTLsInStore "CertEnumCTLsInStore" int, var

; uint CertEnumCertificateContextProperties(winmdroot.Security.Cryptography.CERT_CONTEXT* pCertContext, uint dwPropId)
#cfunc CertEnumCertificateContextProperties "CertEnumCertificateContextProperties" var, int
...
#cfunc CertEnumPhysicalStore "CertEnumPhysicalStore" intptr, int, intptr, int
...
#cfunc CertEnumSubjectInSortedCTL "CertEnumSubjectInSortedCTL" var, var, var, var
...
#cfunc CertEnumSystemStore "CertEnumSystemStore" int, intptr, intptr, int
...
#cfunc CertEnumSystemStoreLocation "CertEnumSystemStoreLocation" int, intptr, int
...
#cfunc CertFindAttribute "CertFindAttribute" str, int, var
...
#cfunc CertFindCRLInStore "CertFindCRLInStore" int, int, int, int, intptr, var
...
#cfunc CertFindCTLInStore "CertFindCTLInStore" int, int, int, int, intptr, var
...
#cfunc CertFindCertificateInCRL "CertFindCertificateInCRL" var, var, int, intptr, var
...
#cfunc CertFindChainInStore "CertFindChainInStore" int, int, int, int, intptr, var
...
#cfunc CertFindExtension "CertFindExtension" str, int, var
...
#cfunc CertFindRDNAttr "CertFindRDNAttr" str, var
...
#cfunc CertFindSubjectInCTL "CertFindSubjectInCTL" int, int, intptr, var, int
...
#func CertFreeServerOcspResponseContext "CertFreeServerOcspResponseContext" var
...
#cfunc CertGetCRLContextProperty "CertGetCRLContextProperty" var, int, intptr, var
...
#cfunc CertGetCRLFromStore "CertGetCRLFromStore" int, var, var, var
...
#cfunc CertGetCTLContextProperty "CertGetCTLContextProperty" var, int, intptr, var
...
#cfunc CertGetCertificateChain "CertGetCertificateChain" intptr, var, var, int, var, int, intptr, var
...
#cfunc CertGetCertificateContextProperty "CertGetCertificateContextProperty" var, int, intptr, var
...
#cfunc CertGetEnhancedKeyUsage "CertGetEnhancedKeyUsage" var, int, var, var
...
#cfunc CertGetIntendedKeyUsage "CertGetIntendedKeyUsage" int, var, var, int
...
#cfunc CertGetIssuerCertificateFromStore "CertGetIssuerCertificateFromStore" int, var, var, var
...
#cfunc CertGetNameStringW "CertGetNameStringW" var, int, int, intptr, wstr, int
...
#cfunc CertGetPublicKeyLength "CertGetPublicKeyLength" int, var
...
#cfunc CertGetServerOcspResponseContext "CertGetServerOcspResponseContext" intptr, int, intptr
...
#cfunc CertGetStoreProperty "CertGetStoreProperty" int, int, intptr, var
...
#cfunc CertGetSubjectCertificateFromStore "CertGetSubjectCertificateFromStore" int, int, var
...
#cfunc CertGetValidUsages "CertGetValidUsages" int, var, var, var, var
...
#cfunc CertIsRDNAttrsInCertificateName "CertIsRDNAttrsInCertificateName" int, int, var, var
...
#cfunc CertIsStrongHashToSign "CertIsStrongHashToSign" var, wstr, var
...
#cfunc CertIsValidCRLForCertificate "CertIsValidCRLForCertificate" var, var, int, intptr
...
#cfunc CertIsWeakHash "CertIsWeakHash" int, wstr, int, var, var, wstr
...
#cfunc CertNameToStrW "CertNameToStrW" int, var, int, wstr, int

; uint CertOIDToAlgId(winmdroot.Foundation.PCSTR pszObjId)
#cfunc CertOIDToAlgId "CertOIDToAlgId" str
...
#cfunc CertOpenServerOcspResponse "CertOpenServerOcspResponse" var, int, var
...
#cfunc CertOpenStore "CertOpenStore" str, int, int, int, intptr
...
#cfunc CertRDNValueToStrW "CertRDNValueToStrW" int, var, wstr, int
...
#cfunc CertRegisterPhysicalStore "CertRegisterPhysicalStore" intptr, int, wstr, var, intptr
...
#cfunc CertRegisterSystemStore "CertRegisterSystemStore" intptr, int, var, intptr
...
#cfunc CertRemoveEnhancedKeyUsageIdentifier "CertRemoveEnhancedKeyUsageIdentifier" var, str
...
#func CertRemoveStoreFromCollection "CertRemoveStoreFromCollection" int, int

; winmdroot.Foundation.BOOL CertResyncCertificateChainEngine(winmdroot.Security.Cryptography.HCERTCHAINENGINE hChainEngine)
#cfunc CertResyncCertificateChainEngine "CertResyncCertificateChainEngine" intptr
...
#cfunc CertRetrieveLogoOrBiometricInfo "CertRetrieveLogoOrBiometricInfo" var, str, int, int, int, intptr, var, var, var
...
#cfunc CertSaveStore "CertSaveStore" int, int, int, int, intptr, int
...
#cfunc CertSelectCertificateChains "CertSelectCertificateChains" var, int, var, int, var, int, var, var
...
#cfunc CertSerializeCRLStoreElement "CertSerializeCRLStoreElement" var, int, var, var
...
#cfunc CertSerializeCTLStoreElement "CertSerializeCTLStoreElement" var, int, var, var
...
#cfunc CertSerializeCertificateStoreElement "CertSerializeCertificateStoreElement" var, int, var, var
...
#cfunc CertSetCRLContextProperty "CertSetCRLContextProperty" var, int, int, intptr
...
#cfunc CertSetCTLContextProperty "CertSetCTLContextProperty" var, int, int, intptr
...
#cfunc CertSetCertificateContextPropertiesFromCTLEntry "CertSetCertificateContextPropertiesFromCTLEntry" var, var, int
...
#cfunc CertSetCertificateContextProperty "CertSetCertificateContextProperty" var, int, int, intptr
...
#cfunc CertSetEnhancedKeyUsage "CertSetEnhancedKeyUsage" var, var
...
#cfunc CertSetStoreProperty "CertSetStoreProperty" int, int, int, intptr
...
#cfunc CertStrToNameW "CertStrToNameW" int, wstr, int, intptr, var, var, var
...
#cfunc CertUnregisterPhysicalStore "CertUnregisterPhysicalStore" intptr, int, wstr

; winmdroot.Foundation.BOOL CertUnregisterSystemStore(void* pvSystemStore, uint dwFlags)
#cfunc CertUnregisterSystemStore "CertUnregisterSystemStore" intptr, int
...
#cfunc CertVerifyCRLRevocation "CertVerifyCRLRevocation" int, var, int, var
...
#cfunc CertVerifyCRLTimeValidity "CertVerifyCRLTimeValidity" var, var
...
#cfunc CertVerifyCTLUsage "CertVerifyCTLUsage" int, int, intptr, var, int, var, var
...
#cfunc CertVerifyCertificateChainPolicy "CertVerifyCertificateChainPolicy" str, var, var, var
...
#cfunc CertVerifyRevocation "CertVerifyRevocation" int, int, int, var, int, var, var
...
#cfunc CertVerifySubjectCertificateContext "CertVerifySubjectCertificateContext" var, var, var
...
#cfunc CertVerifyTimeValidity "CertVerifyTimeValidity" var, var
...
#cfunc CertVerifyValidityNesting "CertVerifyValidityNesting" var, var
...
#cfunc CryptAcquireCertificatePrivateKey "CryptAcquireCertificatePrivateKey" var, int, intptr, var, var, var
...
#cfunc CryptCloseAsyncHandle "CryptCloseAsyncHandle" intptr

; winmdroot.Foundation.BOOL CryptCreateAsyncHandle(uint dwFlags, winmdroot.Security.Cryptography.HCRYPTASYNC* phAsync)
#cfunc CryptCreateAsyncHandle "CryptCreateAsyncHandle" int, intptr
...
#cfunc CryptCreateKeyIdentifierFromCSP "CryptCreateKeyIdentifierFromCSP" int, str, var, int, int, intptr, var, var
...
#cfunc CryptDecodeMessage "CryptDecodeMessage" int, var, var, int, var, int, int, var, var, var, var, var, var
...
#cfunc CryptDecodeObject "CryptDecodeObject" int, str, var, int, int, intptr, var
...
#cfunc CryptDecodeObjectEx "CryptDecodeObjectEx" int, str, var, int, int, var, intptr, var
...
#cfunc CryptDecryptAndVerifyMessageSignature "CryptDecryptAndVerifyMessageSignature" var, var, int, var, int, var, var, var, var
...
#cfunc CryptDecryptMessage "CryptDecryptMessage" var, var, int, var, var, var
...
#cfunc CryptEncodeObject "CryptEncodeObject" int, str, intptr, var, var
...
#cfunc CryptEncodeObjectEx "CryptEncodeObjectEx" int, str, intptr, int, var, intptr, var
...
#cfunc CryptEncryptMessage "CryptEncryptMessage" var, int, var, var, int, var, var
...
#cfunc CryptEnumKeyIdentifierProperties "CryptEnumKeyIdentifierProperties" var, int, int, wstr, intptr, intptr, int
...
#cfunc CryptEnumOIDFunction "CryptEnumOIDFunction" int, str, str, int, intptr, int
...
#cfunc CryptEnumOIDInfo "CryptEnumOIDInfo" int, int, intptr, int
...
#cfunc CryptExportPKCS8 "CryptExportPKCS8" int, int, str, int, intptr, var, var
...
#cfunc CryptExportPublicKeyInfo "CryptExportPublicKeyInfo" int, int, int, var, var
...
#cfunc CryptExportPublicKeyInfoEx "CryptExportPublicKeyInfoEx" int, int, int, str, int, intptr, var, var
...
#cfunc CryptExportPublicKeyInfoFromBCryptKeyHandle "CryptExportPublicKeyInfoFromBCryptKeyHandle" int, int, str, int, intptr, var, var
...
#cfunc CryptFormatObject "CryptFormatObject" int, int, int, intptr, str, var, int, intptr, var

; winmdroot.Foundation.BOOL CryptFreeOIDFunctionAddress(void* hFuncAddr, uint dwFlags)
#cfunc CryptFreeOIDFunctionAddress "CryptFreeOIDFunctionAddress" intptr, int
...
#cfunc CryptGetAsyncParam "CryptGetAsyncParam" intptr, str, var, var
...
#cfunc CryptGetDefaultOIDDllList "CryptGetDefaultOIDDllList" intptr, int, int, var
...
#cfunc CryptGetDefaultOIDFunctionAddress "CryptGetDefaultOIDFunctionAddress" intptr, int, wstr, int, var, var
...
#cfunc CryptGetKeyIdentifierProperty "CryptGetKeyIdentifierProperty" var, int, int, wstr, intptr, intptr, var
...
#cfunc CryptGetMessageCertificates "CryptGetMessageCertificates" int, int, int, var, int

; int CryptGetMessageSignerCount(uint dwMsgEncodingType, byte* pbSignedBlob, uint cbSignedBlob)
#cfunc CryptGetMessageSignerCount "CryptGetMessageSignerCount" int, var, int
...
#cfunc CryptGetOIDFunctionAddress "CryptGetOIDFunctionAddress" intptr, int, str, int, var, var
...
#cfunc CryptGetOIDFunctionValue "CryptGetOIDFunctionValue" int, str, str, wstr, var, var, var
...
#cfunc CryptHashCertificate "CryptHashCertificate" int, int, int, var, int, var, var
...
#cfunc CryptHashCertificate2 "CryptHashCertificate2" wstr, int, intptr, var, int, var, var
...
#cfunc CryptHashMessage "CryptHashMessage" var, int, int, var, var, var, var, var, var
...
#cfunc CryptHashPublicKeyInfo "CryptHashPublicKeyInfo" int, int, int, int, var, var, var
...
#cfunc CryptHashToBeSigned "CryptHashToBeSigned" int, int, var, int, var, var
...
#cfunc CryptImportPKCS8 "CryptImportPKCS8" var, int, var, intptr
...
#cfunc CryptImportPublicKeyInfo "CryptImportPublicKeyInfo" int, int, var, var
...
#cfunc CryptImportPublicKeyInfoEx "CryptImportPublicKeyInfoEx" int, int, var, int, int, intptr, var
...
#cfunc CryptImportPublicKeyInfoEx2 "CryptImportPublicKeyInfoEx2" int, var, int, intptr, var

; void* CryptInitOIDFunctionSet(winmdroot.Foundation.PCSTR pszFuncName, uint dwFlags)
#cfunc CryptInitOIDFunctionSet "CryptInitOIDFunctionSet" str, int
...
#cfunc CryptInstallDefaultContext "CryptInstallDefaultContext" int, int, intptr, int, intptr, var
...
#cfunc CryptInstallOIDFunctionAddress "CryptInstallOIDFunctionAddress" intptr, int, str, int, var, int

; void* CryptMemAlloc(uint cbSize)
#cfunc CryptMemAlloc "CryptMemAlloc" int

; void CryptMemFree([Optional] void* pv)
#func CryptMemFree "CryptMemFree" intptr

; void* CryptMemRealloc([Optional] void* pv, uint cbSize)
#cfunc CryptMemRealloc "CryptMemRealloc" intptr, int
...
#cfunc CryptMsgCalculateEncodedLength "CryptMsgCalculateEncodedLength" int, int, int, intptr, str, int

; winmdroot.Foundation.BOOL CryptMsgClose([Optional] void* hCryptMsg)
#cfunc CryptMsgClose "CryptMsgClose" intptr

; winmdroot.Foundation.BOOL CryptMsgControl(void* hCryptMsg, uint dwFlags, uint dwCtrlType, [Optional] void* pvCtrlPara)
#cfunc CryptMsgControl "CryptMsgControl" intptr, int, int, intptr
...
#cfunc CryptMsgCountersign "CryptMsgCountersign" intptr, int, int, var
...
#cfunc CryptMsgCountersignEncoded "CryptMsgCountersignEncoded" int, var, int, int, var, var, var

; void* CryptMsgDuplicate([Optional] void* hCryptMsg)
#cfunc CryptMsgDuplicate "CryptMsgDuplicate" intptr
...
#cfunc CryptMsgEncodeAndSignCTL "CryptMsgEncodeAndSignCTL" int, var, var, int, var, var
...
#cfunc CryptMsgGetAndVerifySigner "CryptMsgGetAndVerifySigner" intptr, int, var, int, var, var
...
#cfunc CryptMsgGetParam "CryptMsgGetParam" intptr, int, int, intptr, var
...
#cfunc CryptMsgOpenToDecode "CryptMsgOpenToDecode" int, int, int, int, var, var
...
#cfunc CryptMsgOpenToEncode "CryptMsgOpenToEncode" int, int, int, intptr, str, var
...
#cfunc CryptMsgSignCTL "CryptMsgSignCTL" int, var, int, var, int, var, var
...
#cfunc CryptMsgUpdate "CryptMsgUpdate" intptr, var, int, int
...
#cfunc CryptMsgVerifyCountersignatureEncoded "CryptMsgVerifyCountersignatureEncoded" int, int, var, int, var, int, var
...
#cfunc CryptMsgVerifyCountersignatureEncodedEx "CryptMsgVerifyCountersignatureEncodedEx" int, int, var, int, var, int, int, intptr, int, intptr
...
#cfunc CryptQueryObject "CryptQueryObject" int, intptr, int, int, int, var, var, var, var, var, var
...
#cfunc CryptRegisterDefaultOIDFunction "CryptRegisterDefaultOIDFunction" int, str, int, wstr
...
#cfunc CryptRegisterOIDFunction "CryptRegisterOIDFunction" int, str, str, wstr, str

; winmdroot.Foundation.BOOL CryptRegisterOIDInfo(winmdroot.Security.Cryptography.CRYPT_OID_INFO* pInfo, uint dwFlags)
#cfunc CryptRegisterOIDInfo "CryptRegisterOIDInfo" var, int
...
#cfunc CryptRetrieveTimeStamp "CryptRetrieveTimeStamp" wstr, int, int, str, var, var, int, var, var, var

; winmdroot.Foundation.BOOL CryptSIPAddProvider(winmdroot.Security.Cryptography.Sip.SIP_ADD_NEWPROVIDER* psNewProv)
#cfunc CryptSIPAddProvider "CryptSIPAddProvider" var
...
#cfunc CryptSIPLoad "CryptSIPLoad" var, int, var

; winmdroot.Foundation.BOOL CryptSIPRemoveProvider(global::System.Guid* pgProv)
#cfunc CryptSIPRemoveProvider "CryptSIPRemoveProvider" var
...
#cfunc CryptSIPRetrieveSubjectGuid "CryptSIPRetrieveSubjectGuid" wstr, intptr, var
...
#cfunc CryptSIPRetrieveSubjectGuidForCatalogFile "CryptSIPRetrieveSubjectGuidForCatalogFile" wstr, intptr, var
...
#cfunc CryptSetAsyncParam "CryptSetAsyncParam" intptr, str, intptr, int
...
#cfunc CryptSetKeyIdentifierProperty "CryptSetKeyIdentifierProperty" var, int, int, wstr, intptr, intptr
...
#cfunc CryptSetOIDFunctionValue "CryptSetOIDFunctionValue" int, str, str, wstr, int, var, int
...
#cfunc CryptSignAndEncodeCertificate "CryptSignAndEncodeCertificate" int, int, int, str, intptr, var, intptr, var, var
...
#cfunc CryptSignAndEncryptMessage "CryptSignAndEncryptMessage" var, var, int, var, var, int, var, var
...
#cfunc CryptSignCertificate "CryptSignCertificate" int, int, int, var, int, var, intptr, var, var
...
#cfunc CryptSignMessage "CryptSignMessage" var, int, int, var, var, var, var
...
#cfunc CryptSignMessageWithKey "CryptSignMessageWithKey" var, var, int, var, var
...
#cfunc CryptUninstallDefaultContext "CryptUninstallDefaultContext" intptr, int, intptr
...
#cfunc CryptUnregisterDefaultOIDFunction "CryptUnregisterDefaultOIDFunction" int, str, wstr
...
#cfunc CryptUnregisterOIDFunction "CryptUnregisterOIDFunction" int, str, str

; winmdroot.Foundation.BOOL CryptUnregisterOIDInfo(winmdroot.Security.Cryptography.CRYPT_OID_INFO* pInfo)
#cfunc CryptUnregisterOIDInfo "CryptUnregisterOIDInfo" var
...
#cfunc CryptVerifyCertificateSignature "CryptVerifyCertificateSignature" int, int, var, int, var
...
#cfunc CryptVerifyCertificateSignatureEx "CryptVerifyCertificateSignatureEx" int, int, int, intptr, int, intptr, int, intptr
...
#cfunc CryptVerifyDetachedMessageHash "CryptVerifyDetachedMessageHash" var, var, int, int, var, var, var, var
...
#cfunc CryptVerifyDetachedMessageSignature "CryptVerifyDetachedMessageSignature" var, int, var, int, int, var, var, var
...
#cfunc CryptVerifyMessageHash "CryptVerifyMessageHash" var, var, int, var, var, var, var
...
#cfunc CryptVerifyMessageSignature "CryptVerifyMessageSignature" var, int, var, int, var, var, var
...
#cfunc CryptVerifyMessageSignatureWithKey "CryptVerifyMessageSignatureWithKey" var, var, var, int, var, var
...
#cfunc CryptVerifyTimeStampSignature "CryptVerifyTimeStampSignature" var, int, var, int, int, var, var, var
...
#cfunc PFXExportCertStore "PFXExportCertStore" int, var, wstr, int
...
#cfunc PFXExportCertStoreEx "PFXExportCertStoreEx" int, var, wstr, intptr, int
...
#cfunc PFXVerifyPassword "PFXVerifyPassword" var, wstr, int
