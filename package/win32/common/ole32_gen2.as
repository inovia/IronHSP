...
#cfunc BindMoniker "BindMoniker" var, int, var, var

; winmdroot.Foundation.HRESULT CoAllowSetForegroundWindow(winmdroot.System.Com.IUnknown* pUnk, [Optional] void* lpvReserved)
#cfunc CoAllowSetForegroundWindow "CoAllowSetForegroundWindow" var, intptr

; uint CoBuildVersion()
#cfunc CoBuildVersion "CoBuildVersion"
...
#cfunc CoDosDateTimeToFileTime "CoDosDateTimeToFileTime" int, int, var
...
#cfunc CoFileTimeToDosDateTime "CoFileTimeToDosDateTime" var, var, var

; void CoFreeAllLibraries()
#func CoFreeAllLibraries "CoFreeAllLibraries"

; void CoFreeLibrary(winmdroot.Foundation.HINSTANCE hInst)
#func CoFreeLibrary "CoFreeLibrary" intptr
...
#cfunc CoGetInterceptor "CoGetInterceptor" var, var, var, var
...
#cfunc CoGetInterceptorFromTypeInfo "CoGetInterceptorFromTypeInfo" var, var, var, var, var
...
#cfunc CoGetObject "CoGetObject" wstr, var, var, var
...
#cfunc CreateDataCache "CreateDataCache" var, var, var, var
...
#cfunc CreateFileMoniker "CreateFileMoniker" wstr, var
...
#cfunc CreateGenericComposite "CreateGenericComposite" var, var, var
...
#cfunc CreateILockBytesOnHGlobal "CreateILockBytesOnHGlobal" int, int, var
...
#cfunc CreateItemMoniker "CreateItemMoniker" wstr, wstr, var
...
#cfunc CreateObjrefMoniker "CreateObjrefMoniker" var, var

; winmdroot.Foundation.HRESULT CreateOleAdviseHolder(winmdroot.System.Ole.IOleAdviseHolder** ppOAHolder)
#cfunc CreateOleAdviseHolder "CreateOleAdviseHolder" var
...
#cfunc CreatePointerMoniker "CreatePointerMoniker" var, var
...
#cfunc CreateStdProgressIndicator "CreateStdProgressIndicator" intptr, wstr, var, var
...
#cfunc GetHGlobalFromILockBytes "GetHGlobalFromILockBytes" var, var

; winmdroot.Foundation.HRESULT GetRunningObjectTable(uint reserved, winmdroot.System.Com.IRunningObjectTable** pprot)
#cfunc GetRunningObjectTable "GetRunningObjectTable" int, var
...
#cfunc IsAccelerator "IsAccelerator" intptr, int, var, var
...
#cfunc MkParseDisplayName "MkParseDisplayName" var, wstr, var, var
...
#cfunc MonikerCommonPrefixWith "MonikerCommonPrefixWith" var, var, var
...
#cfunc MonikerRelativePathTo "MonikerRelativePathTo" var, var, var, int

; uint OleBuildVersion()
#cfunc OleBuildVersion "OleBuildVersion"
...
#cfunc OleConvertIStorageToOLESTREAM "OleConvertIStorageToOLESTREAM" var, var
...
#cfunc OleConvertIStorageToOLESTREAMEx "OleConvertIStorageToOLESTREAMEx" var, int, int, int, int, var, var
...
#cfunc OleConvertOLESTREAMToIStorage "OleConvertOLESTREAMToIStorage" var, var, var
...
#cfunc OleConvertOLESTREAMToIStorage2 "OleConvertOLESTREAMToIStorage2" var, var, var, int, intptr, int
...
#cfunc OleConvertOLESTREAMToIStorageEx "OleConvertOLESTREAMToIStorageEx" var, var, var, var, var, var, var
...
#cfunc OleConvertOLESTREAMToIStorageEx2 "OleConvertOLESTREAMToIStorageEx2" var, var, var, var, var, var, var, int, intptr, int
...
#cfunc OleCreate "OleCreate" var, var, int, var, var, var, var
...
#cfunc OleCreateDefaultHandler "OleCreateDefaultHandler" var, var, var, var
...
#cfunc OleCreateEmbeddingHelper "OleCreateEmbeddingHelper" var, var, int, var, var, var
...
#cfunc OleCreateEx "OleCreateEx" var, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateFromData "OleCreateFromData" var, var, int, var, var, var, var
...
#cfunc OleCreateFromDataEx "OleCreateFromDataEx" var, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateFromFile "OleCreateFromFile" var, wstr, var, int, var, var, var, var
...
#cfunc OleCreateFromFileEx "OleCreateFromFileEx" var, wstr, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateLink "OleCreateLink" var, var, int, var, var, var, var
...
#cfunc OleCreateLinkEx "OleCreateLinkEx" var, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateLinkFromData "OleCreateLinkFromData" var, var, int, var, var, var, var
...
#cfunc OleCreateLinkFromDataEx "OleCreateLinkFromDataEx" var, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateLinkToFile "OleCreateLinkToFile" wstr, var, int, var, var, var, var
...
#cfunc OleCreateLinkToFileEx "OleCreateLinkToFileEx" wstr, var, int, int, int, var, var, var, var, var, var, var
...
#cfunc OleCreateMenuDescriptor "OleCreateMenuDescriptor" intptr, var
...
#cfunc OleCreateStaticFromData "OleCreateStaticFromData" var, var, int, var, var, var, var

; winmdroot.Foundation.HRESULT OleDestroyMenuDescriptor(nint holemenu)
#cfunc OleDestroyMenuDescriptor "OleDestroyMenuDescriptor" int
...
#cfunc OleDoAutoConvert "OleDoAutoConvert" var, var
...
#cfunc OleDraw "OleDraw" var, int, intptr, var
...
#cfunc OleGetClipboardWithEnterpriseInfo "OleGetClipboardWithEnterpriseInfo" var, var, var, var, var
...
#cfunc OleGetIconOfClass "OleGetIconOfClass" var, wstr, int
...
#cfunc OleGetIconOfFile "OleGetIconOfFile" wstr, int
...
#cfunc OleIsCurrentClipboard "OleIsCurrentClipboard" var

; winmdroot.Foundation.BOOL OleIsRunning(winmdroot.System.Ole.IOleObject* pObject)
#cfunc OleIsRunning "OleIsRunning" var
...
#cfunc OleLoad "OleLoad" var, var, var, var
...
#cfunc OleLoadFromStream "OleLoadFromStream" var, var, var
...
#cfunc OleLockRunning "OleLockRunning" var, int, int
...
#cfunc OleMetafilePictFromIconAndLabel "OleMetafilePictFromIconAndLabel" intptr, wstr, wstr, int
...
#cfunc OleRegGetUserType "OleRegGetUserType" var, int, var

; winmdroot.Foundation.HRESULT OleRun(winmdroot.System.Com.IUnknown* pUnknown)
#cfunc OleRun "OleRun" var
...
#cfunc OleSetContainedObject "OleSetContainedObject" var, int
...
#cfunc OleSetMenuDescriptor "OleSetMenuDescriptor" int, intptr, intptr, var, var
...
#cfunc OleTranslateAccelerator "OleTranslateAccelerator" var, var, var
...
#cfunc ReadFmtUserTypeStg "ReadFmtUserTypeStg" var, var, var
...
#cfunc RegisterDragDrop "RegisterDragDrop" intptr, var
...
#cfunc SetConvertStg "SetConvertStg" var, int
...
#cfunc StgConvertPropertyToVariant "StgConvertPropertyToVariant" var, int, var, var
...
#cfunc StgConvertVariantToProperty "StgConvertVariantToProperty" var, int, var, var, int, int, var
...
#cfunc StgCreateDocfile "StgCreateDocfile" wstr, int, int, var
...
#cfunc StgCreateDocfileOnILockBytes "StgCreateDocfileOnILockBytes" var, int, int, var
...
#cfunc StgCreatePropSetStg "StgCreatePropSetStg" var, int, var
...
#cfunc StgCreatePropStg "StgCreatePropStg" var, var, var, int, int, var
...
#cfunc StgCreateStorageEx "StgCreateStorageEx" wstr, int, int, int, var, int, var, var
...
#cfunc StgGetIFillLockBytesOnFile "StgGetIFillLockBytesOnFile" wstr, var
...
#cfunc StgOpenAsyncDocfileOnIFillLockBytes "StgOpenAsyncDocfileOnIFillLockBytes" var, int, int, var
...
#cfunc StgOpenPropStg "StgOpenPropStg" var, var, int, int, var
...
#cfunc StgOpenStorage "StgOpenStorage" wstr, var, int, var, int, var

; winmdroot.Foundation.HRESULT StgOpenStorageEx(winmdroot.Foundation.PCWSTR pwcsName, winmdroot.System.Com.STGM grfMode, winmdroot.System.Com.StructuredStorage.STGFMT stgfmt, uint grfAttrs, [Optional] winmdroot.System.Com.StructuredStorage.STGOPTIONS* pStgOptions, winmdroot.Security.PSECURITY_DESCRIPTOR pSecurityDescriptor, global::System.Guid* riid, void** ppObjectOpen)
#cfunc StgOpenStorageEx "StgOpenStorageEx" wstr, int, int, int, var, int, var, var
...
#cfunc StgOpenStorageOnILockBytes "StgOpenStorageOnILockBytes" var, var, int, var, int, var
...
#cfunc StgPropertyLengthAsVariant "StgPropertyLengthAsVariant" var, int, int, int
...
#cfunc StgSetTimes "StgSetTimes" wstr, var, var, var
...
#cfunc WriteFmtUserTypeStg "WriteFmtUserTypeStg" var, int, wstr
