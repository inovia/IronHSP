...
#define global __oleaut32_gen2_as__
...
#cfunc global CreateDispTypeInfo "CreateDispTypeInfo" var, int, var

; winmdroot.Foundation.HRESULT CreateErrorInfo(winmdroot.System.Ole.ICreateErrorInfo** pperrinfo)
#cfunc global CreateErrorInfo "CreateErrorInfo" var
...
#cfunc global CreateStdDispatch "CreateStdDispatch" var, intptr, var, var
...
#cfunc global CreateTypeLib "CreateTypeLib" int, wstr, var
...
#cfunc global CreateTypeLib2 "CreateTypeLib2" int, wstr, var
...
#cfunc global DispCallFunc "DispCallFunc" intptr, int, int, int, int, var, var, var
...
#cfunc global DispGetIDsOfNames "DispGetIDsOfNames" var, var, int, var
...
#cfunc global DispGetParam "DispGetParam" var, int, int, var, var
...
#cfunc global DispInvoke "DispInvoke" intptr, var, int, int, var, var, var, var

; int DosDateTimeToVariantTime(ushort wDosDate, ushort wDosTime, double* pvtime)
#cfunc global DosDateTimeToVariantTime "DosDateTimeToVariantTime" int, int, var
...
#cfunc global GetRecordInfoFromGuids "GetRecordInfoFromGuids" var, int, int, int, var, var
...
#cfunc global LoadTypeLibEx "LoadTypeLibEx" wstr, int, var
...
#cfunc global OleCreateFontIndirect "OleCreateFontIndirect" var, var, var
...
#cfunc global OleCreatePictureIndirect "OleCreatePictureIndirect" var, var, int, var
...
#cfunc global OleCreatePropertyFrame "OleCreatePropertyFrame" intptr, int, int, wstr, int, var, int, var, int, int, intptr

; winmdroot.Foundation.HRESULT OleCreatePropertyFrameIndirect(winmdroot.System.Ole.OCPFIPARAMS* lpParams)
#cfunc global OleCreatePropertyFrameIndirect "OleCreatePropertyFrameIndirect" var
...
#cfunc global OleLoadPicture "OleLoadPicture" var, int, int, var, var
...
#cfunc global OleLoadPictureEx "OleLoadPictureEx" var, int, int, var, int, int, int, var
...
#cfunc global OleLoadPictureFile "OleLoadPictureFile" var, var
...
#cfunc global OleLoadPictureFileEx "OleLoadPictureFileEx" var, int, int, int, var
...
#cfunc global OleLoadPicturePath "OleLoadPicturePath" wstr, var, int, int, var, var
...
#cfunc global OleSavePictureFile "OleSavePictureFile" var, int
...
#cfunc global OleTranslateColor "OleTranslateColor" int, intptr, var
...
#cfunc global QueryPathOfRegTypeLib "QueryPathOfRegTypeLib" var, int, int, int, var
...
#cfunc global RegisterActiveObject "RegisterActiveObject" var, var, int, var
...
#cfunc global RegisterTypeLib "RegisterTypeLib" var, wstr, wstr
...
#cfunc global SafeArrayAllocDescriptorEx "SafeArrayAllocDescriptorEx" int, int, var
...
#cfunc global SafeArrayCopyData "SafeArrayCopyData" var, var
...
#cfunc global SafeArrayCreate "SafeArrayCreate" int, int, var
...
#cfunc global SafeArrayCreateEx "SafeArrayCreateEx" int, int, var, intptr
...
#cfunc global SafeArrayCreateVectorEx "SafeArrayCreateVectorEx" int, int, int, intptr

; winmdroot.Foundation.HRESULT SafeArrayDestroy(winmdroot.System.Com.SAFEARRAY* psa)
#cfunc global SafeArrayDestroy "SafeArrayDestroy" var

; winmdroot.Foundation.HRESULT SafeArrayDestroyData(winmdroot.System.Com.SAFEARRAY* psa)
#cfunc global SafeArrayDestroyData "SafeArrayDestroyData" var
...
#cfunc global SafeArrayGetRecordInfo "SafeArrayGetRecordInfo" var, var
...
#cfunc global SafeArrayRedim "SafeArrayRedim" var, var

; void SafeArrayReleaseData(void* pData)
#func global SafeArrayReleaseData "SafeArrayReleaseData" intptr

; void SafeArrayReleaseDescriptor(winmdroot.System.Com.SAFEARRAY* psa)
#func global SafeArrayReleaseDescriptor "SafeArrayReleaseDescriptor" var

; winmdroot.Foundation.HRESULT SafeArraySetIID(winmdroot.System.Com.SAFEARRAY* psa, global::System.Guid* guid)
#cfunc global SafeArraySetIID "SafeArraySetIID" var, var
...
#cfunc global UnRegisterTypeLib "UnRegisterTypeLib" var, int, int, int, int
...
#cfunc global VarAdd "VarAdd" var, var, var
...
#cfunc global VarBoolFromDec "VarBoolFromDec" var, var
...
#cfunc global VarBstrCat "VarBstrCat" int, int, var
...
#cfunc global VarBstrCmp "VarBstrCmp" int, int, int, int
...
#cfunc global VarBstrFromBool "VarBstrFromBool" int, int, int, var
...
#cfunc global VarBstrFromCy "VarBstrFromCy" var, int, int, var

; winmdroot.Foundation.HRESULT VarBstrFromDate(double dateIn, uint lcid, uint dwFlags, winmdroot.Foundation.BSTR* pbstrOut)
#cfunc global VarBstrFromDate "VarBstrFromDate" double, int, int, var
...
#cfunc global VarBstrFromDec "VarBstrFromDec" var, int, int, var
...
#cfunc global VarBstrFromDisp "VarBstrFromDisp" var, int, int, var
...
#cfunc global VarCat "VarCat" var, var, var
...
#cfunc global VarDateFromUdateEx "VarDateFromUdateEx" var, int, int, var
...
#cfunc global VarDecSub "VarDecSub" var, var, var
...
#cfunc global VarDiv "VarDiv" var, var, var
...
#cfunc global VarFormat "VarFormat" var, wstr, int, int, int, var
...
#cfunc global VarFormatCurrency "VarFormatCurrency" var, int, int, int, int, int, var
...
#cfunc global VarFormatDateTime "VarFormatDateTime" var, int, int, var
...
#cfunc global VarFormatFromTokens "VarFormatFromTokens" var, wstr, var, int, var, int
...
#cfunc global VarFormatNumber "VarFormatNumber" var, int, int, int, int, int, var
...
#cfunc global VarIdiv "VarIdiv" var, var, var
...
#cfunc global VarNumFromParseNum "VarNumFromParseNum" var, var, int, var
...
#cfunc global VarOr "VarOr" var, var, var
...
#cfunc global VarParseNumFromStr "VarParseNumFromStr" wstr, int, int, var, var
...
#cfunc global VarPow "VarPow" var, var, var
...
#cfunc global VarRound "VarRound" var, int, var
...
#cfunc global VarSub "VarSub" var, var, var
...
#cfunc global VarWeekdayName "VarWeekdayName" int, int, int, int, var
...
#cfunc global VarXor "VarXor" var, var, var
...
#cfunc global VariantChangeType "VariantChangeType" var, var, int, int
...
#cfunc global VariantChangeTypeEx "VariantChangeTypeEx" var, var, int, int, int

; winmdroot.Foundation.HRESULT VariantClear(winmdroot.System.Variant.VARIANT* pvarg)
#cfunc global VariantClear "VariantClear" var
...
#cfunc global VariantCopy "VariantCopy" var, var
...
#cfunc global VariantCopyInd "VariantCopyInd" var, var
...
#cfunc global VariantTimeToDosDateTime "VariantTimeToDosDateTime" double, var, var

; int VariantTimeToSystemTime(double vtime, winmdroot.Foundation.SYSTEMTIME* lpSystemTime)
#cfunc global VariantTimeToSystemTime "VariantTimeToSystemTime" double, var

; winmdroot.Foundation.HRESULT VectorFromBstr(winmdroot.Foundation.BSTR bstr, winmdroot.System.Com.SAFEARRAY** ppsa)
#cfunc global VectorFromBstr "VectorFromBstr" int, var
