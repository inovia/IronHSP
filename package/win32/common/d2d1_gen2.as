...
#define global __d2d1_gen2_as__
...
#cfunc global D2D1ComputeMaximumScaleFactor "D2D1ComputeMaximumScaleFactor" var
...
#cfunc global D2D1ConvertColorSpace "D2D1ConvertColorSpace" int, int, var
...
#cfunc global D2D1CreateDevice "D2D1CreateDevice" var, var, var
...
#cfunc global D2D1CreateDeviceContext "D2D1CreateDeviceContext" var, var, var
...
#cfunc global D2D1CreateFactory "D2D1CreateFactory" int, var, var, var
...
#cfunc global D2D1InvertMatrix "D2D1InvertMatrix" var

; winmdroot.Foundation.BOOL D2D1IsMatrixInvertible(winmdroot.Graphics.Direct2D.Common.D2D_MATRIX_3X2_F* matrix)
#cfunc global D2D1IsMatrixInvertible "D2D1IsMatrixInvertible" var
...
#func global D2D1MakeRotateMatrix "D2D1MakeRotateMatrix" float, var, var
...
#func global D2D1MakeSkewMatrix "D2D1MakeSkewMatrix" float, float, var, var

; void D2D1SinCos(float angle, float* s, float* c)
#func global D2D1SinCos "D2D1SinCos" float, var, var

; float D2D1Tan(float angle)
#cfunc global D2D1Tan "D2D1Tan" float

; float D2D1Vec3Length(float x, float y, float z)
#cfunc global D2D1Vec3Length "D2D1Vec3Length" float, float, float
