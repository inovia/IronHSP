...
#ifdef HSPDISH
            hgio_mtouchid( touchID, (int)__touchPoints[i].x, (int)__touchPoints[i].y, 1, i );
#endif
...
#ifdef HSPDISH
	            hgio_mtouchid( touchID, (int)touchPoint.x * WINDOW_SCALE, (int)touchPoint.y * WINDOW_SCALE, 0, i );
#endif
                found = true;
            }
        }
...
Platform* Platform::create(Game* game, void *attachToWindow, int sizex, int sizey, bool fullscr)
{
