...
def main():
    ...
    cpp.append('#include "hsp3dx_ios_dxlib_override.h"  // iOS 時 LoadGraph/LoadSoundMem をラッパへ差替')
    ...
    fcpp.append('#include "hsp3dx_ios_dxlib_override.h"  // iOS 時 LoadGraph/LoadSoundMem をラッパへ差替')
