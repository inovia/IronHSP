...
RE_P005 = re.compile(r'PInvoke005.*?"([^"]+)"')
...
def collect_unsupported(log: str):
    """Return dict name -> reason string."""
    bad = {}
    ...
    for m in RE_P005.finditer(log):
        bad.setdefault(m.group(1), "PInvoke005 AnyCPU incompatible")
